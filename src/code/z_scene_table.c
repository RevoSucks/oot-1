...
#define DEFINE_ENTRANCE(enum, scene, spawn, continueBgm, displayTitleCard, fadeIn, fadeOut) \
    { scene, spawn,                                                                         \
...
#define DEFINE_TITLE_SCENE(enum, name, title, unk_10, config, unk_12) \
...
#define DEFINE_SCENE(enum, name, unk_10, config, unk_12) \
